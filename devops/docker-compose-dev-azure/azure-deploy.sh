...
resourcename="flinstones1"  # lower case, only
resourcegroup="flinstones1_rg"
...
# git clone https://github.com/apilogicserver/flinstones1.git
# cd flinstones1
...
az group create --name flinstones1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group flinstones1_rg --sku S1 --is-linux
az container create --resource-group flinstones1_rg --name flinstones1 --image apilogicserver/flinstones1:latest --dns-name-label flinstones1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//flinstones1.westus.azurecontainer.io:5656'
