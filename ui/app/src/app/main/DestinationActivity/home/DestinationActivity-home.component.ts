...
@Component({
  selector: 'DestinationActivity-home',
  templateUrl: './DestinationActivity-home.component.html',
  styleUrls: ['./DestinationActivity-home.component.scss']
})
export class DestinationActivityHomeComponent implements AfterViewInit {
