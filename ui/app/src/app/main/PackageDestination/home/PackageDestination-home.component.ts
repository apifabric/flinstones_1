...
@Component({
  selector: 'PackageDestination-home',
  templateUrl: './PackageDestination-home.component.html',
  styleUrls: ['./PackageDestination-home.component.scss']
})
export class PackageDestinationHomeComponent implements AfterViewInit {
