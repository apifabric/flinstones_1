...
@Component({
  selector: 'UserPreference-home',
  templateUrl: './UserPreference-home.component.html',
  styleUrls: ['./UserPreference-home.component.scss']
})
export class UserPreferenceHomeComponent implements AfterViewInit {
