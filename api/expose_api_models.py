...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.DestinationActivity, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.PackageDestination, method_decorators= method_decorators)
